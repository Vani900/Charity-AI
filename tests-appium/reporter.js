...
class TestReporter {
  constructor() {
    ...
    this.outputPath = path.join(RESULTS_DIR, `CharityChain_Mobile_TestReport_${ts}.xlsx`);
    this.latestPath = path.join(RESULTS_DIR, `CharityChain_Mobile_TestReport.xlsx`);
  }
  ...
  _buildSummarySheet(wb) {
    ...
    titleCell.value = 'CharityChain — Appium Android Mobile E2E Test Report';
    titleCell.font = { name: 'Calibri', bold: true, size: 16, color: { argb: C_HEADER_FG } };
    ...
    subCell.value = `Generated: ${runDate}   |   Framework: Appium UIAutomator2 (Node.js/WebdriverIO)   |   App ID: com.charitychain.ai`;
